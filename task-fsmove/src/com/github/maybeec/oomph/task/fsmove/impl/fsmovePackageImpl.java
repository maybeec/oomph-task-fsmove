...
public class fsmovePackageImpl extends EPackageImpl implements fsmovePackage {
	...
	public void initializePackageContents() {
		...
		// Create resource
		createResource("https://raw.githubusercontent.com/maybeec/oomph-task-fsmove/master/task-fsmove-updatesite/model/Oomph-task-fsmove.ecore");
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "schemaLocation", "https://raw.githubusercontent.com/maybeec/oomph-task-fsmove/master/task-fsmove-updatesite/model/Oomph-task-fsmove.ecore"
		   });
	}
		...
		addAnnotation
		  (fsMoveTaskEClass, 
		   ...
		   new String[] {
			 ...
			 "repository", "https://maybeec.github.io/oomph-task-fsmove/update/",

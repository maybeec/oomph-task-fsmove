 ...
 * @generated
 */
public class fsmoveAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected fsmoveSwitch<Adapter> modelSwitch =
		new fsmoveSwitch<Adapter>() {
			@Override
			public Adapter caseFSMoveTask(FSMoveTask object) {
				return createFSMoveTaskAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.github.maybeec.oomph.task.fsmove.FSMoveTask <em>FS Move Task</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFSMoveTaskAdapter() {
		return null;
	}
